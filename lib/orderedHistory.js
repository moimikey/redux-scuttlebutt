...
exports.reducer = exports.getState = undefined;
...
var getState = exports.getState = function getState(state) {
  ...
  return lastState && lastState[_constants.STATE_SNAPSHOT];
};
...
var reducer = exports.reducer = function reducer(_reducer) {
  return function () {
    ...
    for (stateIndex = currentState.length - 1; stateIndex >= -1; stateIndex--) {
      var thisTimestamp = currentState[stateIndex] && currentState[stateIndex][_constants.STATE_TIMESTAMP],
          thisSnapshot = stateIndex === -1 ? undefined : currentState[stateIndex][_constants.STATE_SNAPSHOT];
    ...
    for (stateIndex = stateIndex + 2; stateIndex < currentState.length; stateIndex++) {
      var thisState = currentState[stateIndex],
          thisAction = thisState[_constants.STATE_ACTION],
          lastState = currentState[stateIndex - 1],
          lastSnapshot = lastState ? lastState[_constants.STATE_SNAPSHOT] : undefined;
      ...
      */
      ...
      thisState[_constants.STATE_SNAPSHOT] = _reducer(lastSnapshot, thisAction);
    }
